...
Giao diện màn hình chính PHẢI hiển thị tuỳ chọn "See all" cạnh tiêu đề "Market Highlights" cho phép người dùng mở trang danh sách đầy đủ.
...
Màn hình danh sách toàn bộ coin PHẢI thực hiện việc gọi API trang tiếp theo khi người dùng cuộn đến phần tử gần cuối của danh sách hiện tại.
...
Danh sách hiển thị trên giao diện PHẢI tiếp tục nối thêm các coin mới vào sau các coin hiện có mà không làm tải lại (reload) toàn bộ danh sách.
...
Hệ thống PHẢI dừng việc gửi yêu cầu API mới nếu trang cuối cùng trả về ít hơn 50 phần tử.
